...
class LoadingScreen(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        title = QLabel(tr("VISION ULTIMATE"))
        title.setObjectName("ls_title")
        title.setAlignment(Qt.AlignCenter)
        lay.addWidget(title)

        tag = QLabel(tr("Automated Optical Inspection"))
        ...
        self._status = QLabel(tr("Đang khởi động…"))
