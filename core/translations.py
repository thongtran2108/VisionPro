...
_ENTRIES: List[Tuple[str, str, str, str]] = [
    ...
    ("🔑 Bản quyền: còn lại {days} ngày",
     "🔑 License: {days} days remaining",
     "🔑 Bản quyền: còn lại {days} ngày",
     "🔑 授权：剩余 {days} 天"),
    ("(hết hạn {date})", "(expires {date})", "(hết hạn {date})", "（到期 {date}）"),
    ("🔑 Bản quyền đã hết hạn", "🔑 License expired",
     "🔑 Bản quyền đã hết hạn", "🔑 授权已过期"),
    ("🔑 Bản quyền: vĩnh viễn", "🔑 License: perpetual",
     "🔑 Bản quyền: vĩnh viễn", "🔑 授权：永久"),
