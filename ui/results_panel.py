...
class ResultsPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Yield bar
        yield_lbl = QLabel(tr("Yield Rate"))
        ...
        # Duration
        self._dur_lbl = QLabel(tr("Last run: —"))
        ...
        log_title = QLabel(tr("Execution Log"))
    ...
    def _clear_log(self):
        ...
        self._yield_bar.setValue(0)
        self._dur_lbl.setText(tr("Last run: —"))
