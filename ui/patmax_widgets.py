...
class ModelPreviewWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._thumb.setText(tr("No Model"))
        lay.addWidget(self._thumb)

        # Info
        info = QWidget()
        il = QVBoxLayout(info); il.setContentsMargins(0,0,0,0); il.setSpacing(3)
        self._name_lbl = QLabel(tr("No model trained"))
        ...
        # Status badge
        self._badge = QLabel(tr("UNTRAINED"))
    ...
    def update_model(self, model: Optional[PatMaxModel]):
        ...
        self._name_lbl.setText(tr("Model Trained ✔"))
        self._name_lbl.setStyleSheet(
        ...
        self._badge.setText(tr("TRAINED"))
        self._badge.setStyleSheet(
        ...
        if model.thumbnail is not None:
            ...
            self._thumb.setText(tr("No thumb"))
